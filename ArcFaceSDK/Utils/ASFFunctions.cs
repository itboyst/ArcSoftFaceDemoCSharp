...
namespace ArcFaceSDK.Utils
{
    ...
    public static class ASFFunctions
    {
        ...
        /// <summary>
        /// 设置人脸属性阈值，取值范围[0-1]， 默认阈值:0.5， 用户可以根据实际需求设置
        /// </summary>
        /// <param name="pEngine">[in] 引擎handle</param>
        /// <param name="threshhold">[in] 人脸各属性阈值</param>
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, EntryPoint = "ASFSetFaceAttributeParam", CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFSetFaceAttributeParam(IntPtr pEngine, IntPtr threshhold);
        ...
        /// <summary>
        /// 取值范围[0-1]，默认值 BGR:0.5 IR:0.5， 用户可以根据实际需求，设置不同的阈值
        /// </summary>
        /// <param name="hEngine">[in] 引擎handle</param>
